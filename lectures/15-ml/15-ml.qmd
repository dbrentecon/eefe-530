...
There is a shortcut for regression that allows us to calculate this with only one model run by exploiting the residuals and the *leverage statistic* $(h_i)$.<sup>*****</sup>
