...
Problem Set 3: Presentations of new methods
...
The estimator avoids problematic comparisons because:

- Treated units are **never used as controls for already-treated units.**
- Each DID comparison uses groups with **identical treatment status in the pre-period.**

Therefore heterogeneous treatment effects do not generate biased weights.
